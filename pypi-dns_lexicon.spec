...
%prep
%setup -q -n dns-lexicon-3.9.4
cd %{_builddir}/dns-lexicon-3.9.4
...
cp %{_builddir}/dns-lexicon-3.9.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dns_lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
