...
Source0  : https://files.pythonhosted.org/packages/14/bd/df17c559e2817c2ac420a6146adbee9fd655d143079336c63f339206b128/dns-lexicon-3.11.2.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.11.2
cd %{_builddir}/dns-lexicon-3.11.2
pushd ..
cp -a dns-lexicon-3.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653058770
...
cp %{_builddir}/dns-lexicon-3.11.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dns_lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
