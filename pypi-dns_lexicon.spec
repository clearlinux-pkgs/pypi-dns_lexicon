...
Source0  : https://files.pythonhosted.org/packages/76/9a/5fa6474f41188f17e1c58cc38bb12148882068dcc3271a113c8be18b1523/dns-lexicon-3.11.4.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.11.4
cd %{_builddir}/dns-lexicon-3.11.4
pushd ..
cp -a dns-lexicon-3.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660263814
...
cp %{_builddir}/dns-lexicon-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dns_lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
