...
Version  : 3.9.5
Release  : 67
URL      : https://files.pythonhosted.org/packages/50/24/8357ef2cf07d096b2b8d16d65c113ddb761e9add5e9951f22fdfc7a942d0/dns-lexicon-3.9.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/50/24/8357ef2cf07d096b2b8d16d65c113ddb761e9add5e9951f22fdfc7a942d0/dns-lexicon-3.9.5.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.9.5
cd %{_builddir}/dns-lexicon-3.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650383655
...
cp %{_builddir}/dns-lexicon-3.9.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dns_lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
