...
Source0  : https://files.pythonhosted.org/packages/ca/e6/c87afe904ca8a757949161d917f4663a8455249921039fb13398ad4dbada/dns_lexicon-3.11.5.tar.gz
...
%prep
%setup -q -n dns_lexicon-3.11.5
cd %{_builddir}/dns_lexicon-3.11.5
pushd ..
cp -a dns_lexicon-3.11.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665445049
