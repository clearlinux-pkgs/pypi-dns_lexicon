...
Source0  : https://files.pythonhosted.org/packages/60/58/055f9552cafeeac094a5e0334fe0eaf4cbf8e1485cc545a26c079ca632f1/dns_lexicon-3.21.1.tar.gz
...
%prep
%setup -q -n dns_lexicon-3.21.1
cd %{_builddir}/dns_lexicon-3.21.1
pushd ..
cp -a dns_lexicon-3.21.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745878277
