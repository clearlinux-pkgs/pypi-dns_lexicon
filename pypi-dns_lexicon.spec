...
Source0  : https://files.pythonhosted.org/packages/94/26/0394bc0d3da5a4d51b255efec699098d95d68d505966b57250a3f1e7e4dc/dns_lexicon-3.11.6.tar.gz
...
%prep
%setup -q -n dns_lexicon-3.11.6
cd %{_builddir}/dns_lexicon-3.11.6
pushd ..
cp -a dns_lexicon-3.11.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665599911
