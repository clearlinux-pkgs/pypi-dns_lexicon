...
Source0  : https://files.pythonhosted.org/packages/de/7f/1088bb43e65813ea634d2b0edb230611db72f932652c60140e1e29bf30c4/dns_lexicon-3.21.0.tar.gz
...
%prep
%setup -q -n dns_lexicon-3.21.0
cd %{_builddir}/dns_lexicon-3.21.0
pushd ..
cp -a dns_lexicon-3.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744160573
