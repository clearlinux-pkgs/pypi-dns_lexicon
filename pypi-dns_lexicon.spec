...
Source0  : https://files.pythonhosted.org/packages/01/a6/0e889bff0516d3cfec95d78139f896c31e89639a8e1f9bc93a5b7be363f7/dns_lexicon-3.17.0.tar.gz
...
%prep
%setup -q -n dns_lexicon-3.17.0
cd %{_builddir}/dns_lexicon-3.17.0
pushd ..
cp -a dns_lexicon-3.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699374688
