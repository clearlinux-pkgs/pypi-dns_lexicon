...
Version  : 3.10.0
Release  : 68
URL      : https://files.pythonhosted.org/packages/3d/73/d6780531f4e8b0f7aec8abc5cd4a40ef61c939ffc9ccb15778a1622a25af/dns-lexicon-3.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3d/73/d6780531f4e8b0f7aec8abc5cd4a40ef61c939ffc9ccb15778a1622a25af/dns-lexicon-3.10.0.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.10.0
cd %{_builddir}/dns-lexicon-3.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651521905
...
cp %{_builddir}/dns-lexicon-3.10.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-dns_lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
